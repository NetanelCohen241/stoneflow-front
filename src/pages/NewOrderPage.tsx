...
export default function NewOrderPage() {
  ...
  return (
    <div className="p-4 pb-24 md:pb-4 space-y-6">
      <h2 className="text-2xl font-bold">{t('newOrder')}</h2>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="border-t pt-6">
          ...
          <div className="mt-4 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button type="button" onClick={handleAddCutout} className="text-sm text-blue-600 hover:underline">
                + Add Cutout
              </button>
            </div>
        ...
        {/* Submit Order */}
        <button type="submit" className="w-full bg-accent text-white py-2 rounded-md hover:bg-orange-600">
          {t('newOrder')}
        </button>
      </form>
    </div>
